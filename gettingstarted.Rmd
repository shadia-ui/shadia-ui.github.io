...
The purpose of this package is to distribute code used to run the American shad dam passage performance standard model. Currently, the model is implemented for the **Connecticut**, **Kennebec**, **Merrimack**, **Mohawk and Hudson**, **Penobscot**, **Saco**, and **Susquehanna** rivers, USA, but we are actively adding new rivers. The main package functions include `connecticutRiverModel()`, `kennebecRiverModel()`, `merrimackRiverModel()`, `mohawkHudsonRiverModel()`, `penobscotRiverModel()`, `sacoRiverModel()`, and `susquehannaRiverModel()`. 
