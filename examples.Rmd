...
<a href = "examples/variable_mhr.html">Variable passage with random sampling</a> example using `mohawkHudsonRiverModel()`. These simulations are most useful when a wide range of un-coupled passage efficiencies or upstream `timing` are considered. <br>
